...
//
bool HSTRING::RangePositionsAreValid( unsigned int FirstCharPosition, unsigned int LastCharPosition, unsigned int Length )
{
...
//		may be greater than the last position, indicating that the range is in the reverse direction.
//
bool HSTRING::RangePositionsAreValid( unsigned int FirstCharPosition, unsigned int LastCharPosition )
{
...
//
unsigned int HSTRING::RangeLength( unsigned int FirstCharPosition, unsigned int LastCharPosition, unsigned int Length )
{
...
//		position may be greater than the last position, indicating that the range is in the reverse direction.
//
unsigned int HSTRING::RangeLength( unsigned int FirstCharPosition, unsigned int LastCharPosition )
{
...
//		position may be greater than the last position, indicating that the range is in the reverse direction.
//
int HSTRING::RangeDirection( unsigned int FirstCharPosition, unsigned int LastCharPosition, unsigned int Length )
{
	int	Direction = 0;
...
//		position may be greater than the last position, indicating that the range is in the reverse direction.
//
int HSTRING::RangeDirection( unsigned int FirstCharPosition, unsigned int LastCharPosition )
{
...
// operation will fail.
//
bool HSTRING::Append(HSTRING *StringToAppend)
{
	unsigned int	i;
...
//      actually copied.
//
unsigned int HSTRING::CopyFromString(unsigned char *CopyDestination, unsigned int MaximumDestinationLength)
{
	unsigned int		i;	// Index
...
//
bool HSTRING::CopyFromString(unsigned int IndexToStartOfCopyLocation, unsigned int LengthToCopy, HSTRING *CopyDestination)
{
...
//
bool HSTRING::CopyFromString(HSTRING *CopyDestination)
{
...
// If this string shouldn't be writable, WOOF!
	...
	pwcSerialString[Size]=NULL;				//terminate this UNICODE string
	Copy((char *) pwcSerialString, (Size + 1) * 2);
	Size -= 2;
...
// 	Takes a string in unicode format (wchar_t) and strips the upper byte, assuming LITTLE ENDIAN
//
...
// If this string shouldn't be writable, WOOF!
	...
	for(uiCtr=0;uiCtr<(Size / 2);uiCtr++)
		Char[uiCtr] = Char[uiCtr*2];
	Size /= 2;
	Char[Size] = 0;
...
//
int HSTRING::CompareFixedInputLength(const unsigned char *InputString, unsigned int InputStringLength, bool CompareIsCaseSensitive)
{
	int		StringComparisonResult;
...
//			up to the length of the input string.
//
int HSTRING::CompareFixedInputLength(HSTRING *InputString, bool CompareIsCaseSensitive)
{
...
//			up to the length of the input string.
//
int HSTRING::CompareFixedInputLength(const unsigned char *InputString, bool CompareIsCaseSensitive)
{
...
//			up to the length of the input string.
//
int HSTRING::CompareFixedInputLength(const char *InputString, unsigned int InputStringLength, bool CompareIsCaseSensitive)
{
...
//			up to the length of the input string.
//
int HSTRING::CompareFixedInputLength(const char *InputString, bool CompareIsCaseSensitive)
{
...
//
int HSTRING::MaximumLength(void)
{
	return(MaximumSize);
}	// MaximumLength
