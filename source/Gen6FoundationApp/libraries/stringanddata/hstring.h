...
// Overloaded version #1 of string append:  Append another HSTRING to the end of the local string.
	bool Append(HSTRING *StringToAppend);
...
// CopyFromString (overloaded version #8: HSTRING* output WITHOUT maximum length)
	bool CopyFromString(unsigned int IndexToStartOfCopyLocation, unsigned int LengthToCopy, HSTRING *CopyDestination);

// CopyFromString (overloaded version #9: HSTRING* output WITHOUT maximum length, copying the entire string)
	bool CopyFromString(HSTRING *CopyDestination);
...
// and specified length).
	int CompareFixedInputLength(const unsigned char *InputString, unsigned int InputStringLength, bool CompareIsCaseSensitive);

// Compare the input string to the local HSTRING up to the length of the input HSTRING (overloaded version #2
// with HSTRING* input).
	int CompareFixedInputLength(HSTRING *InputString, bool CompareIsCaseSensitive);
...
// version #3 with unsigned char* input).
	int CompareFixedInputLength(const unsigned char *InputString, bool CompareIsCaseSensitive);

// Compare the input string to the local HSTRING up to the input length (overloaded version #4 with char* input
// and specified length).
	int CompareFixedInputLength(const char *InputString, unsigned int InputStringLength, bool CompareIsCaseSensitive);
...
// version #5 with char* input).
	int CompareFixedInputLength(const char *InputString, bool CompareIsCaseSensitive);
