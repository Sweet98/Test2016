...
@param saltLen      [Input]        The length of the salt. The recommended 
                                   value is <tt>digestLen</tt>.
@param signatureLen [Input/Output] The length in bytes of the signature. This 
                                   must be at least the modulus length.
...
@param digestLen    [Input]  The length in bytes of the message digest.
@param digest       [Input]  The message digest.
@param saltLen      [Input]  The length of the salt that was used to generate 
                             the signature. The recommended value of 
			     <tt>saltLen</tt> is <tt>digestLen</tt>. The value 
			     of <tt>saltLen</tt> must match the value of 
			     <tt>saltLen</tt> that was used to generate the 
			     signature.
@param signatureLen [Input]  The length in bytes of the signature. This must be 
