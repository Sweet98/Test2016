...
@param macAlgId [Input]  The MAC algorithm identifier.
@param keyLen   [Input]  The length (in bytes) of the MAC key value.
@param key      [Input]  The MAC key value.
@param macKey   [Output] The MAC key object pointer.
...
@param macKey   [Input]        The MAC key object.
@param macAlgId [Output]       The MAC algorithm identifier.
@param keyLen   [Input/Output] The length (in bytes) of the MAC key value.
@param key      [Input/Output] The key value.
@param sbCtx    [Input]        A global context.
...
@param macKey [Input] The MAC key object pointer.
@param sbCtx  [Input] A global context.
...
@param macKey     [Input]  The MAC key object.
@param macContext [Output] The MAC context object pointer.
@param sbCtx      [Input]  A global context.
...
@param macContext [Input] The MAC context object.
@param dataLen    [Input] The length (in bytes) of the data.
@param data       [Input] The data value.
@param sbCtx      [Input] A global context.
...
@param macContext [Input/Output] The MAC context object pointer.
@param tagLen     [Input/Output] The length (in bytes) of the tag.
@param tag        [Output]       The MAC output.
@param sbCtx      [Input]        A global context.
