...
//======================================================================================
// $RCSfile: db_shared/Hardware_Header_Files/iMX27/iMX27_csi.h $
// $Revision: 1.1 $
...
// Refer to Chapter 39 Page 1375 of the iMX27 Reference Manual
//
//------------------------------------------------------------------------------
#ifndef IMX27_CSI_H_
#define IMX27_CSI_H_
...
#define CSI_DEBUG                (CSI_BASE_ADDR+0x18)       // 32bit csi debug reg
#define CSI_CSICR3               (CSI_BASE_ADDR+0x1C)       // 32bit csi control 3 reg
...
#define CSI_CSICR1_RXFF_LEVEL_WID		Width_2
#define CSI_CSICR1_STATFF_INTEN_WID		Width_1
#define CSI_CSICR1_STATFF_LEVEL_WID		Width_2
...
#define CSI_CSICR3_CSI_SVR_WID			Width_1
