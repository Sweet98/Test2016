/*=================================================================================
  A helper for CTransCode to support CP950
//=================================================================================
   $Source: Gen6FoundationApp/FoundationApp/eci/transcp950.cpp $
//=================================================================================*/
//! \file
...
extern const wchar_t Table_CP950[];


/// Handler for the CP950 translation.
/*!
*/
class CTransInfoCP950 : public CTransInfoBase
{
public:
	CTransInfoCP950(codepage_t codepage);
	virtual ~CTransInfoCP950();
protected:
...
CTransInfoCP950::CTransInfoCP950(codepage_t codepage)
...
, m_pBackTable(NULL)
{
	...
	{
		size_t Unicode = Table_CP950[i];
		m_pBackTable[Unicode] = (wchar_t) i;
	}
}

CTransInfoCP950::~CTransInfoCP950()
{
	delete m_pBackTable;
}

// Below is an atempt to create a memory saving Unicode to CP950 translation (slow).
// While writing it I decided to use the table version. I keep the code here for reference.
//size_t CTransInfoCP950::SearchInTable(wchar_t search, wchar_t start, wchar_t end)
//{
//	size_t Index=0;
//	for(size_t i=start; i<=end; i++)
//	{
//		if(search==Table_CP950[i])
//		{
//			Index=i;
//			break;
//		}
...
//	return Index;
//}
// CAUTION: output buffer must be big enough. CP950 can be 2x bigger than UTF16!
//MatrixError_t CTransInfoCP950::FromUnicode(const wchar_t *pIn, size_t length, bchar_t *pOut, size_t &DestinationSize)
//{
...
MatrixError_t CTransInfoCP950::FromUnicode(const wchar_t *pIn, bchar_t *pOut, size_t &DestinationSize)
{
	return FromUnicode(pIn, wcslen(pIn), pOut, DestinationSize);
}

MatrixError_t CTransInfoCP950::ToUnicode(const bchar_t *pIn, size_t length, wchar_t *pOut, size_t &DestinationSize)
{
	MatrixError_t RetVal=ERR_PASS;
	size_t Index=0;
...
MatrixError_t CTransInfoCP950::ToUnicode(const bchar_t *pIn, wchar_t *pOut, size_t &DestinationSize)
{
	return ToUnicode(pIn, strlen(pIn), pOut, DestinationSize);
}

///////////////////////////////////////////////////////////////////////////////
//! Create the CP950 handler.
/*!
*/
void	CTransCode::CreateCp950Translator(void)
{
	const int codepage = CP950;
	if(m_TransInfo[codepage] == NULL)	// only create if not done yet (memory leak!)
	{
		m_TransInfo[codepage] = new CTransInfoCP950(codepage);
	}
}
