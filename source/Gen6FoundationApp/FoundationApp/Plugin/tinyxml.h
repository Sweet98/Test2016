...
public:
	...
	*/
	virtual void Print( F_FILE* cfile, int depth ) const = 0;
...
public:
	...
	*/
	...
	virtual void Print( F_FILE* cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
	void Print( F_FILE* cfile, int depth, TIXML_STRING* str ) const;
...
public:
	...
	virtual void Print( F_FILE* cfile, int depth, TIXML_STRING* str ) const;
	virtual void Print( F_FILE* cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
...
public:
	...
	*/
	bool LoadFile( F_FILE*, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( F_FILE* ) const;
...
//		return ( f.buffer && SaveFile( f.buffer ));
	...
	*/
	...
	virtual void Print( F_FILE* cfile, int depth = 0 ) const;
	// [internal use]
