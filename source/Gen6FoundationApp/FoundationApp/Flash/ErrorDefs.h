...
//=================================================================================
   $Source: Gen6FoundationApp/FoundationApp/Flash/ErrorDefs.h $
   $Date: 2008/09/22 11:15:01EDT $
   $Revision: 1.1 $
...
//! The standard error return value for all Matrix devices.
typedef unsigned long MatrixError_t;
...
*/
inline USHORT GetErrValue(MatrixError_t number)
{
	return (USHORT)(number & OK_VAL_MASK);
}
...
*/
inline MatrixError_t MakeErrReturnValue(USHORT val)
{
	return (((MatrixError_t)val) | OK_VAL_BIT);
}

#endif /* ERROR_DEFS_H_F3E1EF42_35D6_11D2_93BE_00805F2987D9 */
